...
echo "     psql \$DATABASE_URL -c \"SELECT datname FROM pg_database WHERE datname='_odoo_template';\""
echo ""
echo "  2. Check template is marked correctly:"
echo "     psql \$DATABASE_URL -c \"SELECT datname, datistemplate FROM pg_database WHERE datname='_odoo_template';\""
echo ""
